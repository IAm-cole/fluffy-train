...
const Contact = () => {
  return (
    ...
    >
      <h1 className="text-xl   bg-slate-500 rounded-lg  my-6   mx-auto  justify-items-center  md:text-2xl md:font-bold  text-gray-600  p-2 bg-gradient-to-r from-yellow-600 to-purple-400  ">
        Contact Me
      </h1>
      {/* <div className="  flex    "> */}
      <div className=" items-center   block    md:flex md:justify-center space-x-4 md:space-x-10  w-full text-white   cursor-pointer     ">
        ...
        <div className="flex flex-col items-center justify-center   border rounded-lg  bg-gradient-to-r from-green-600 to-slate-700  h-48 p-4  ">
