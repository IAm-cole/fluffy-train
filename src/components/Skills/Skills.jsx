  ...
  return (
    <>
      <div id="skills" className="flex justify-center ">
        <div className="  inline-block  bg-gray-900 h-96 w-full      md:bg-gray-900  md:w-3/4 md:mr-20     border-white md:h-36 md:items-center md:inline-block   rounded-tr-xl rounded-br-xl  rounded-tl-3xl rounded-bl-3xl  ">
          ...
          <div className="grid justify-items-center md:flex md:justify-between w-full h-80 md:h-16    mt-4    ">
            <div className=" flex justify-center  md:flex-col mr-7   items-center gap-2   ">
              <img
                src={cus}
                alt="Javascript"
                className="md:ml-2 rounded-lg md:w-10    h-9 "
              />
            ...
            <div className="flex justify-center gap-2 mt-4  md:flex-col  items-center w-9 mr-7">
              <img src={style} alt="css" className=" rounded-lg md:w-10  h-9  " />
              <p className="  text-gray-300 text-lg md:text-lg font-serif ">
                CSS
              </p>git
            </div>
